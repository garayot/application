...
export function IERPrint({ applications, position }: IERPrintProps) {
  // Ensure we have exactly 10 rows as requested
  ...
  return (
    <div className="print-only font-serif p-4 w-[297mm] mx-auto text-[8pt]" style={{ fontFamily: "'Times New Roman', serif", color: "black" }}>
        ...
        <tbody>
          {displayRows.slice(0, 10).map((app, index) => (
            <tr key={index} className="h-10">
              <td className="border border-black p-1 text-center text-[7pt]">{index + 1}</td>
